  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-indigo-50 via-white to-sky-50 px-4">
      ...
      {loading ? (
        ...
        <Card className="w-full max-w-xl rounded-3xl border border-white/50 bg-white/70 backdrop-blur-xl shadow-[0_25px_60px_rgba(0,0,0,0.08)] transition-all">
          ...
          <CardContent className="p-10 flex flex-col items-center gap-8">
            ...
            <div className="w-full flex flex-col sm:flex-row gap-3 pt-4">
              <Button variant="outline" className="flex-1 rounded-xl" onClick={logoutHandler}>
                Logout
              </Button>
              <Button className="flex-1 rounded-xl bg-gradient-to-r from-indigo-500 to-blue-600 text-white shadow-md hover:opacity-90"
